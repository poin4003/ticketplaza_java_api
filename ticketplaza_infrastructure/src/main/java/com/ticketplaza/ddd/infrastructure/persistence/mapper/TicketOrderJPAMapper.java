...
public interface TicketOrderJPAMapper extends JpaRepository<TicketDetail, Long> {
     ...
     * Use CAS technique (compare and swap) to decrease quantity
     * @param ticketId The ID of the ticket item
    ...
    int decreaseStock(@Param("ticketId") Long ticketId, @Param("oldStockAvailable") int oldStockAvailable, @Param("quantity") int quantity);
}
